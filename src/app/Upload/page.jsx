...
//                 <button type="submit"
//                 onClick={handleClick} 
//                 className='px-6 py-3 my-1 w-fit rounded-full mr-4 bg-white hover:bg-slate-300  text-white bg-gradient-to-br from-[#13163F] to-[#67E331]'>{showMe ? 'Hide it..' : 'Upload and generate 3D Model'}</button> {showMe && <ModelViewer modelPath={`http://127.0.0.1:5000/static/output/final.stl`}/>}
//                 </div>
//             </form>
//             {downloadUrl && (
//                 <div>
...
export default function UploadDicomFolder() {
    ...
    const [selectedFiles, setSelectedFiles] = useState(null);
    const [downloadUrl, setDownloadUrl] = useState("");
    const [modelPath, setModelPath] = useState(null); // New state to track model path
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Set the model path to trigger immediate rendering
            setModelPath('http://127.0.0.1:5000/static/output/final.stl');
    ...
    return (
        ...
        <div className='bg-gray-200 py-8 mt-20' id='Upload'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                />
                <button type="submit"
                className='px-6 py-3 my-1 w-fit rounded-full mr-4 bg-white hover:bg-slate-300  text-white bg-gradient-to-br from-[#13163F] to-[#67E331]'>
                    Upload and generate 3D Model
                </button>
                </div>
            </form>
            
            {/* Conditionally render ModelViewer based on modelPath */}
            {showMe && modelPath && (
